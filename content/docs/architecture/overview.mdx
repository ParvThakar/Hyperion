...
<Files>
  ...
  <Folder name="packages" defaultOpen>
    ...
    <Folder name="cli">
      <File name="Scaffolding CLI (create-hyperion)" />
    </Folder>
...
Instead of delegating linting and formatting to individual packages via Turborepo, Hyperion uses **Biome (via the Ultracite preset)** as a single root-level tool.
