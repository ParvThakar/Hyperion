...
export interface SpecularButtonProps extends ComponentProps<"button"> {
  asChild?: boolean;
  autoAnimate?: boolean;
  baseColor?: string;
  blur?: number;
...
export function SpecularButton({
  ...
  useEffect(() => {
    ...
    if ("uv" in geometry.attributes) {
      // biome-ignore lint/performance/noDelete: OGL geometry clean attribute structure
  ...
  const content = (
    <>
      <span aria-hidden="true" className="specular-button__fx" ref={fxRef} />
