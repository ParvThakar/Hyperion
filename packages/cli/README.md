...
Scaffolding CLI for [Hyperion](https://github.com/BhagirathsinhRana378/hyperion). Creates a new cross-platform monorepo project (Web + Desktop + Mobile) from the Hyperion.

## Usage

```bash
npm create hyperion@latest
```
...
```bash
pnpm create hyperion@latest
yarn create hyperion@latest
npx create-hyperion@latest
bunx create-hyperion@latest
```
...
```bash
npm create hyperion@latest --name <your-project-name> --github-user <your-github-username> --no-install
```
...
1. Downloads the Hyperion template from GitHub
...
- [Documentation](https://hyperion.dev/docs)
- [GitHub](https://github.com/BhagirathsinhRana378/hyperion)
- [Issues](https://github.com/BhagirathsinhRana378/hyperion/issues)

## License

[MIT](https://github.com/BhagirathsinhRana378/hyperion/blob/master/LICENSE)
